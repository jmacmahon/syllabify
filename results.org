...
|-------+--------------+--------------+--------------+----------------------------+----------|
| p     | hitchhikers  | dahl_rowling | Yes          | hitchhikers < dahl_rowling |  2.12e-3 |
| b     | elicited     | real         | Yes          | elicited > real            |  2.06e-4 |
| b     | elicited     | hitchhikers  | Yes          | elicited > hitchhikers     |  2.65e-3 |
| b     | real         | carroll_lear | Yes          | real < carroll_lear        |  2.16e-6 |
| b     | real         | dahl_rowling | Yes          | real < dahl_rowling        |  2.96e-3 |
| b     | carroll_lear | hitchhikers  | Yes          | carroll_lear > hitchhikers |  9.41e-5 |
| t     | elicited     | real         | Yes          | elicited < real            |  2.39e-7 |
| t     | real         | carroll_lear | Yes          | real > carroll_lear        |  4.94e-6 |
| t     | real         | dahl_rowling | Yes          | real > dahl_rowling        | 2.18e-11 |
| t     | real         | gullivers    | Yes          | real > gullivers           |  8.99e-7 |
| t     | hitchhikers  | dahl_rowling | Yes          | hitchhikers > dahl_rowling |  6.98e-4 |
| d     | elicited     | gullivers    | Yes          | elicited < gullivers       |  1.68e-3 |
| g     | elicited     | real         | Yes          | elicited > real            |  8.62e-5 |
| g     | real         | hitchhikers  | Yes          | real < hitchhikers         |  2.78e-6 |
| g     | real         | dahl_rowling | Yes          | real < dahl_rowling        |  4.29e-5 |
| g     | real         | gullivers    | Yes          | real < gullivers           |  1.94e-6 |
| f     | real         | carroll_lear | Yes          | real < carroll_lear        |  7.02e-4 |
| f     | carroll_lear | hitchhikers  | Yes          | carroll_lear > hitchhikers |  2.97e-3 |
| v     | elicited     | real         | Yes          | elicited < real            |  2.14e-8 |
| v     | elicited     | hitchhikers  | Yes          | elicited < hitchhikers     |  8.30e-4 |
| v     | real         | dahl_rowling | Yes          | real > dahl_rowling        |  3.52e-4 |
| v     | real         | gullivers    | Yes          | real > gullivers           | 5.66e-13 |
| v     | hitchhikers  | dahl_rowling | Yes          | hitchhikers > dahl_rowling |  4.73e-3 |
| v     | hitchhikers  | gullivers    | Yes          | hitchhikers > gullivers    |  2.88e-4 |
| ð     | elicited     | real         | Yes          | elicited < real            | 4.38e-12 |
| ð     | real         | hitchhikers  | Yes          | real > hitchhikers         | 4.38e-12 |
| ð     | real         | dahl_rowling | Yes          | real > dahl_rowling        | 4.38e-12 |
| ð     | real         | gullivers    | Yes          | real > gullivers           | 4.38e-12 |
| s     | elicited     | real         | Yes          | elicited < real            |  1.60e-3 |
| ʒ     | real         | carroll_lear | Yes          | real > carroll_lear        |  6.65e-8 |
| ʒ     | real         | hitchhikers  | Yes          | real > hitchhikers         |  6.65e-8 |
| ʒ     | real         | dahl_rowling | Yes          | real > dahl_rowling        |  6.65e-8 |
| ʒ     | real         | gullivers    | Yes          | real > gullivers           |  6.65e-8 |
| ʤ     | real         | gullivers    | Yes          | real > gullivers           |   0.00e0 |
| ʤ     | carroll_lear | gullivers    | Yes          | carroll_lear > gullivers   |  2.49e-3 |
| ʤ     | hitchhikers  | gullivers    | Yes          | hitchhikers > gullivers    |  1.85e-4 |
| m     | carroll_lear | hitchhikers  | Yes          | carroll_lear > hitchhikers |  2.19e-3 |
| n     | elicited     | real         | Yes          | elicited < real            |  5.84e-4 |
| n     | real         | carroll_lear | Yes          | real > carroll_lear        |  8.59e-6 |
| n     | real         | hitchhikers  | Yes          | real > hitchhikers         |  8.11e-4 |
| n     | real         | dahl_rowling | Yes          | real > dahl_rowling        |  8.75e-4 |
| n     | carroll_lear | gullivers    | Yes          | carroll_lear < gullivers   |  1.31e-3 |
| l     | elicited     | gullivers    | Yes          | elicited < gullivers       |  1.77e-6 |
| l     | real         | hitchhikers  | Yes          | real < hitchhikers         |  8.56e-4 |
| l     | real         | gullivers    | Yes          | real < gullivers           | 9.59e-14 |
| l     | carroll_lear | gullivers    | Yes          | carroll_lear < gullivers   |  1.04e-9 |
| l     | hitchhikers  | gullivers    | Yes          | hitchhikers < gullivers    |  4.90e-5 |
| l     | dahl_rowling | gullivers    | Yes          | dahl_rowling < gullivers   |  2.38e-7 |
| r     | carroll_lear | hitchhikers  | Yes          | carroll_lear < hitchhikers |  5.26e-4 |
| r     | carroll_lear | gullivers    | Yes          | carroll_lear < gullivers   |  3.47e-3 |
| w     | elicited     | dahl_rowling | Yes          | elicited < dahl_rowling    |  1.99e-3 |
| w     | real         | dahl_rowling | Yes          | real < dahl_rowling        |  9.83e-4 |
| w     | dahl_rowling | gullivers    | Yes          | dahl_rowling > gullivers   |  5.25e-4 |
| j     | real         | carroll_lear | Yes          | real > carroll_lear        |  4.40e-3 |
| j     | real         | gullivers    | Yes          | real > gullivers           |  4.78e-3 |
| h     | elicited     | real         | Yes          | elicited < real            |  1.51e-3 |
| h     | elicited     | hitchhikers  | Yes          | elicited < hitchhikers     |  3.63e-3 |
| ŋ     | elicited     | real         | Yes          | elicited > real            |  2.02e-3 |
| ŋ     | elicited     | gullivers    | Yes          | elicited > gullivers       |  4.97e-3 |
| ɫ     | elicited     | real         | Yes          | elicited > real            |  1.41e-7 |
| ɫ     | elicited     | hitchhikers  | Yes          | elicited > hitchhikers     |  4.25e-4 |
| ɫ     | elicited     | gullivers    | Yes          | elicited > gullivers       |  1.52e-8 |
| ɫ     | real         | carroll_lear | Yes          | real < carroll_lear        |  1.86e-6 |
| ɫ     | real         | hitchhikers  | Yes          | real < hitchhikers         |  1.79e-3 |
| ɫ     | real         | dahl_rowling | Yes          | real < dahl_rowling        |  7.77e-6 |
| ɫ     | real         | gullivers    | Yes          | real > gullivers           |   0.00e0 |
| ɫ     | carroll_lear | hitchhikers  | Yes          | carroll_lear > hitchhikers |  1.55e-3 |
| ɫ     | carroll_lear | gullivers    | Yes          | carroll_lear > gullivers   |  2.64e-7 |
| ɫ     | hitchhikers  | gullivers    | Yes          | hitchhikers > gullivers    |  8.09e-5 |
| ɫ     | dahl_rowling | gullivers    | Yes          | dahl_rowling > gullivers   |  6.25e-7 |
* Question 5
** T-Tests
